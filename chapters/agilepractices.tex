...
Als zweiter methodischer Teil wurde eine Evaluation der zuvor erarbeiteten agilen Methoden vorgesehen. Diese soll nach einem klaren Schema erfolgen, welches nachfolgend erläutert wird. Grundsätzlich folgt die Evaluation keinem verbreiteten Schema, es wurde für die nachfolgenden Ergebnisse eigens konzipiert.
