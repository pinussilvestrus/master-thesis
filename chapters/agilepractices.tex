...
Die Suche nach Aussagen in Bezug auf SAFe gestaltete sich schwierig, da sich viele Inhalte auf die Anwendung der innerhalb der SAFe-Organisation definierten agilen Methoden bezogen. Oft wurde die übergeordnete Methodik von SAFe eingesetzt, um generell das Problem der agilen Skalierung zu begegnen. Dieses findet sich aber nicht innerhalb der erarbeiteten Problemfelder der Digitalen Transformation wieder. Insgesamt konnten innerhalb der Untersuchung keine eindeutigen Aussagen gefunden werden. Dies sollte jedoch nicht so gedeutet werden, als dass die SAFe-Methode gar nicht innerhalb der Digitalen Transformation  einzusetzen ist. Sie bietet aus theoretischer Sicht einen Ansatzpunkt für die Skalierung auf Unternehmensebene und kann so als Katalysator für die Ausdehnung von Veränderungsprozessen dienen.
...
Die Methode Squads and Tribes wurde verhältnismäßig wenig  genannt, bietet aber trotzdem Ansatzpunkte für Lösungen der Problemfelder. Beispielsweise führen \citeA{heinemann_digitale_2016} folgende Aussage auf:
